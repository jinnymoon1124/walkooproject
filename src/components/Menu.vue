<template>
    ...
    <router-link v-for="(menu, index) in menus" :key="index" :to="menu.path" class="menu-item" :class="{'active': activeMenu === index}">
      <img :src="menu.image" alt="" class="menu-image">
...
export default {
  ...
  data() {
    return {
      menus: [
        {
          image: require("@/assets/Menu/ranking.png"),
          text: '랭킹',
          path: '/Ranking'
        },
        {
          image: require("@/assets/Menu/friendlist.png"),
          text: '친구',
          path: '/FriendList'
        },
        {
          image: require("@/assets/Menu/mainpage.png"),
          text: '홈',
          path: '/'
        },
        {
          image: require("@/assets/Menu/store.png"),
          text: '상점',
          path: '/Store'
        },
        {
          image: require("@/assets/Menu/mypage.png"),
          text: 'MY',
          path: '/MyPage'
        }
      ],
